...
class InformationControllerTest < ActionController::TestCase
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post :create, information: { author: @information.author, category: @information.category, date_of_submit: @information.date_of_submit, description: @information.description, title: @information.title }
    end
  ...
  test "should update information" do
    patch :update, id: @information, information: { author: @information.author, category: @information.category, date_of_submit: @information.date_of_submit, description: @information.description, title: @information.title }
    assert_redirected_to information_path(assigns(:information))
  end
